...
import subscriptionRoutes from './routes/subscriptions.js'; // ✅ MUST include Stripe route
...
app.use('/api/subscriptions', subscriptionRoutes); // 🔥 Stripe + subscription logic
